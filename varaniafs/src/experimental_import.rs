//! Reader раннего экспериментального образа; используется только host-миграцией.
//!
...
pub const MAGIC: [u8; 8] = [86, 65, 82, 78, 70, 83, 49, 0];
...
/// protocol, заменив экспериментальный layout рабочим B+tree.
#[repr(C)]
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
...
/// учебного прототипа, но rename каталога всё равно транзакционен: меняются все

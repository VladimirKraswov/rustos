...
//!   (выделена загрузчиком из свободных регионов UEFI memory map и
//!   зафиксирована там; детали в docs/adr/0002).
...
/// Полная структура BootInfo v1.
///
/// # Layout
///
/// Проверен compile-time: размер фиксирован, выравнивание 8 байт.
#[repr(C)]
#[derive(Clone, Copy, Debug)]
pub struct BootInfo {

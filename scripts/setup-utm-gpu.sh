...
on run argv
    ...
    tell application "UTM"
        ...
        set qemu additional arguments of c to {{argument string:"-machine"}, {argument string:"virt,acpi=off,gic-version=3"}, {argument string:"-global"}, {argument string:"virtio-mmio.force-legacy=false"}, {argument string:"-drive"}, {argument string:espArgument, file urls:{espImage}}, {argument string:"-device"}, {argument string:"virtio-blk-pci,drive=rustosesp,bootindex=0"}, {argument string:"-drive"}, {argument string:systemArgument, file urls:{systemImage}}, {argument string:"-device"}, {argument string:"virtio-blk-device,drive=rustossystem"}, {argument string:"-device"}, {argument string:"virtio-keyboard-device"}, {argument string:"-device"}, {argument string:"virtio-mouse-device"}}
